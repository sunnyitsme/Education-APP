-- =============================================================
-- CBSE Class 10 AI Study Assistant - Seed data (MVP) - v2
-- v2: reworded lesson text so that no string literal or comment contains
--     an internal semicolon (some SQL editors split scripts at each one).
...
(
  ...
  '',
  'Write SQL keywords in CAPITALS and end every statement with a semicolon. Examiners look for correct syntax. Always include the WHERE clause in UPDATE/DELETE answers.',
...
('44444444-0000-0000-0000-000000010007', '11111111-0000-0000-0000-000000000001', '22222222-0000-0000-0000-000000010005', null, 'mcq',
 ...
 'a = 2 and d = 5, so a10 = a + 9d = 2 + 45 = 47.', 1, 'easy'),
...
('44444444-0000-0000-0000-000000010010', '11111111-0000-0000-0000-000000000001', '22222222-0000-0000-0000-000000010003', null, 'assertion_reason',
 ...
 'Here 1/2 = 2/4 = 5/10, so the lines coincide, and R correctly states the condition.', 1, 'medium')
on conflict (id) do nothing;
...
('77777777-0000-0000-0000-000000000003', '66666666-0000-0000-0000-000000000001', '11111111-0000-0000-0000-000000000002', '22222222-0000-0000-0000-000000020001', '33333333-0000-0000-0000-000200010001', 3,
 ...
 '2Na + 2H2O -> 2NaOH + H2. Observation: the reaction is vigorous and exothermic, and hydrogen gas evolves and may catch fire.',
...
('77777777-0000-0000-0000-000000000004', '66666666-0000-0000-0000-000000000001', '11111111-0000-0000-0000-000000000002', '22222222-0000-0000-0000-000000020011', '33333333-0000-0000-0000-000200110002', 4,
 ...
 'R = rho x l / A, so resistance is proportional to length and inversely proportional to area.', 'medium', 2024),
...
('77777777-0000-0000-0000-000000000006', '66666666-0000-0000-0000-000000000001', '11111111-0000-0000-0000-000000000002', '22222222-0000-0000-0000-000000020011', '33333333-0000-0000-0000-000200110003', 6,
 ...
 '(a) Series: R = 4 + 12 = 16 ohm. (b) Parallel: 1/R = 1/4 + 1/12 = 4/12, so R = 3 ohm. Current: series I = 12/16 = 0.75 A and parallel I = 12/3 = 4 A. The current drawn is more in the parallel combination.',
...
('88888888-0000-0000-0000-000000000002', '11111111-0000-0000-0000-000000000006',
 ...
 'Summary sheet updates automatically when a subject sheet changes. Goal Seek shows the required English marks, and the macro replays the header formatting.', 10, 'medium'),
